...
/**
 *	\file       budgetreport/budgetreportindex.php
 *	\ingroup    budgetreport
 *	\brief      Home page of budgetreport top menu
 */
...
$langs->loadLangs(array("budgetreport@budgetreport"));

$action = GETPOST('action', 'aZ09');


// Security check
// if (! $user->rights->budgetreport->myobject->read) {
// 	accessforbidden();
// }
...
<div class="info hideonsmartphone" style='clear:both;'>
<ul>
<li>Only open projects with budget value more than 0 are visible (projects in draft or closed status are not visible).
<li>The budget for each project is divided equally for each month according to the project timeline.
</ul>
</div>
