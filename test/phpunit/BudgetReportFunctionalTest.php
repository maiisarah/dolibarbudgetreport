...
/**
 * \file    test/phpunit/BudgetReportFunctionalTest.php
...
/**
 * Class BudgetReportFunctionalTest
 *
 ...
 *
 * @package Testbudgetreport
 */
class BudgetReportFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBudgetReport')->click();
		} else {
			// Disable the module
			$this->byHref('modBudgetReport')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/budgetreport/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('budgetreport/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/budgetreport/admin/about.php');
		$this->authenticate();
		return $this->assertContains('budgetreport/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('budgetreportwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBudgetReport_BudgetReportTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBudgetReport_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
